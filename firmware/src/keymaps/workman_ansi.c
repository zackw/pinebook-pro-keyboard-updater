...
__code __at (0x0815) uint16_t keymap[] = KEYMAP_ANSI(
    ...
    R(TAB),   R(Q), R(D), R(R), R(W), R(B), R(J), FK(4), FK(5), FK(6), FK(11), R(LBRC), R(RBRC), R(BSLS),
    R(CAPS),   R(A), R(S), R(H), R(T), R(G), R(Y), FK(1), FK(2), FK(3), FK(12), R(QUOT), R(ENT),
    M(LSFT),    FR(0), R(X), R(M), R(C), R(V), R(K), FK(0), R(COMM), FK(13), FK(14), M(RSFT), FR(6),
